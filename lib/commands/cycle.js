  ...
  if (usageText) {
    ...
    var subcommandFuncs = {
      launch: function launch() {
        return handleUpdateCycleStateCommand('PRACTICE', '🚀  Initiating Launch... stand by.', notify, opts);
      },
      retro: function retro() {
        return handleUpdateCycleStateCommand('RETROSPECTIVE', '🤔  Initiating Retrospective... stand by.', notify, opts);
      }
    };
